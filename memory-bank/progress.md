...
- Bumped the service-worker static cache to `arclight-static-v31` so installed clients cannot continue using pre-Lao-rollout HTML/CSS/JS and stale local mini-app fragments.
