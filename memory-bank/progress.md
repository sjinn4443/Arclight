...
- Bumped the service-worker static cache to `arclight-static-v25` so installed clients cannot continue rendering the obsolete wide-row mobile CSS and pre-rename Medical Students fragment.
