...
- The PWA static cache is now `arclight-static-v34`, forcing installed clients to reload the Fundal Reflex examination narration controls and current HTML/CSS/JS behavior.
