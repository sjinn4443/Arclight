        ...
        (function (C, De) {
          ...
          var mi = (function () {
            ...
            return function (u, h) {
              ...
              for (var k = u.length, y = [], E = 0; E < k; ++E)
                y.push(n(u.charCodeAt(E)));
              ...
              for (var gt = [], Jt, ut = 0; ut < k; )
                if (l.test(y[ut])) {
                  ...
                  for (var mt = ir; mt < ut; )
                    if (a.test(y[mt])) {
                      ir < mt &&
                        (gt.splice(Fr, 0, new s(1, ir, mt)), (Fr += Er));
                      var on = mt;
                      for (++mt; mt < ut && a.test(y[mt]); ++mt);
                      (gt.splice(Fr, 0, new s(2, on, mt)),
                        (Fr += Er),
                        (ir = mt));
                    } else ++mt;
            ...
            if (Or == null) {
              ...
              (G(e, d("span", [t, document.createTextNode("x")])),
                e.firstChild.offsetHeight != 0 &&
                  (Or =
                    t.offsetWidth <= 1 && t.offsetHeight > 2 && !(b && W < 8)));
            }
            var n = Or
              ? d("span", "​")
              : d(
...
`,
          ...
          ((Je.prototype.eol = function () {
            ...
            (Je.prototype.column = function () {
              return (
                ...
                this.lastColumnValue -
                  (this.lineStart
                    ? Ce(this.string, this.lineStart, this.tabSize)
                    : 0)
              );
            }),
          ...
          function f(e) {
            ...
            for (
              var t = e.parent, n = de(t.lines, e), r = t.parent;
              r;
              t = r, r = r.parent
            )
          ...
          function Me(e, t) {
            ...
            return t.line > n
              ? D(n, ge(e, n).text.length)
              : Ra(t, ge(e, t.line).text.length);
          }
          function Ra(e, t) {
            var n = e.ch;
                  ...
                  ((n.state = !0),
                    wo(
                      ...
                      function (y, E) {
                        for (var H = v; k < y; ) {
                          var Z = i[v];
                          (Z > y && i.splice(v, 1, y, i[v + 1], Z),
                            (v += 2),
                            (k = Math.min(y, Z)));
                        }
                        if (E)
                          if (h.opaque)
                            (i.splice(H, v - H, y, "overlay " + E),
                              (v = H + 2));
                          else
                            for (; H < v; H += 2) {
                              var Q = i[H + 1];
          ...
          function bi(e, t, n, r) {
            ...
            for (
              o.start = o.pos = r || 0, t == "" && xo(i, n.state);
              !o.eol();
            )
          ...
          function qa(e, t, n) {
            for (
              ...
              if (
                u &&
                (!n ||
                  a + (u instanceof _n ? u.lookAhead : 0) <= o.modeFrontier)
              )
                return a;
            ...
            if (!u) {
              ...
              if (ie > 0 && a)
                for (var ue = 0; ue < a.length; ++ue)
                  a[ue].to == null &&
                    (V || (V = [])).push(new Rn(a[ue].marker, null, null));
          ...
          function No(e, t) {
            ...
            return (
              ...
              r.pre.className &&
                (r.textClass = ne(r.pre.className, r.textClass || "")),
              r
            );
          }
          function is(e) {
...
`
            ...
            for (
              ...
              if (y == s) {
                ...
                for (var V = [], ue = void 0, be = 0; be < r.length; ++be) {
                  var me = r[be],
                    Ne = me.marker;
                  if (Ne.type == "bookmark" && me.from == s && Ne.widgetNode)
                    V.push(Ne);
                  else if (
                    me.from <= s &&
                    (me.to == null ||
                      me.to > s ||
                      (Ne.collapsed && me.to == s && me.from == s))
                  ) {
                    if (
                      (me.to != null &&
                        me.to != s &&
            ...
            if (o.nodeType == 3) {
              for (var h = 0; h < 4; h++) {
                ...
                for (
                  ...
                  Ee(t.line.text.charAt(i.coverStart + a));
                )
                  ++a;
                if (
          ...
          function jt(e, t, n, r, i, o) {
            ...
            function l(E, H) {
              ...
              return (
                H ? (Z.left = Z.right) : (Z.right = Z.left),
                Yn(e, r, Z, n)
              );
            }
          ...
          function Oi(e, t, n) {
            ...
            var i = g(r, n),
              o = r.first + r.size - 1;
            if (i > o)
              return Ni(r.first + r.size - 1, ge(r, o).text.length, null, 1, 1);
            t < 0 && (t = 0);
            for (var l = ge(r, i); ; ) {
              var a = Ss(e, l, i, t, n),
            ...
            var a = Pt(
                function (v) {
                  ...
                  return Pi(
                    jt(
                      e,
                      D(n, y ? k.to : k.from, y ? "before" : "after"),
                      "line",
                      t,
                      r,
                    ),
              ...
              if (!(y.from >= u || y.to <= s)) {
                var E = y.level != 1,
                  H = Zt(
                    e,
                    r,
                    E ? Math.min(u, y.to) - 1 : Math.max(s, y.from),
                  ).right,
                  Z = H < o ? o - H + 1e9 : H - o;
                (!h || v > Z) && ((h = y), (v = Z));
              }
          ...
          function Lr(e, t, n, r) {
            ...
            if (
              r &&
              s.xRel > 0 &&
              (u = ge(e.doc, s.line).text).length == s.ch
            ) {
          ...
          function Ds(e, t, n) {
                ...
                var nt = Vo(e, me, null, tt),
                  ...
                  Qe =
                    ft == "after"
                      ? nt.begin
                      : nt.end -
                        (/\s/.test(me.text.charAt(nt.end - 1)) ? 2 : 1);
                return Xe(Qe, rt)[rt];
              }
            ...
            if (k.line == y.line) v(k.line, k.ch, y.ch);
              ...
              (Z &&
                (Q.top < ie.top - 2
                  ? (h(Q.right, Q.top, null, Q.bottom),
                    h(a, ie.top, ie.left, ie.bottom))
          ...
          function As(e, t, n, r) {
            ...
            !e.options.lineWrapping &&
              ...
              (t = t.ch
                ? D(t.line, t.sticky == "before" ? t.ch - 1 : t.ch, "after")
                : t));
            for (var o = 0; o < 5; o++) {
              var l = !1,
                a = jt(e, t),
          ...
          function kn(e, t) {
            e.doc.highlightFrontier < e.display.viewTo &&
              e.state.highlight.set(t, pe(Hs, e));
          }
          function Hs(e) {
            var t = e.doc;
              ...
              if (!r || !e.options.lineWrapping || t.oldDisplayWidth == wr(e)) {
                if (
                  (n &&
                    ...
                    (n = {
                      top: Math.min(
                        e.doc.height + Mi(e.display) - Ai(e),
                        n.top,
                      ),
                    }),
            ...
            for (var s = r.view, u = r.viewFrom, h = 0; h < s.length; h++) {
              ...
              if (!v.hidden)
                if (!v.node || v.node.parentNode != o) {
                  ...
                  (v.changes &&
                    (de(v.changes, "gutter") > -1 && (y = !1), Io(e, v, u, n)),
                    y &&
                      (M(v.lineNumber),
                      v.lineNumber.appendChild(
                        document.createTextNode(X(e.options, u)),
                      )),
          ...
          function pl(e, t) {
            ...
            if ((r && s) || (i && u)) {
              ...
              if (i && o != null) {
                ...
                (y < 0
                  ? (E = Math.max(0, E + y - 50))
                  : (H = Math.min(e.doc.height, H + y + 50)),
                  Ui(e, { top: E, bottom: H }));
              }
              ri < 20 &&
                t.deltaMode !== 0 &&
          ...
          function Qi(e, t, n, r) {
            ...
            function l(ie, V) {
              for (var ue = [], be = ie; be < V; ++be)
                ue.push(new _r(u[be], i(be), r));
              return ue;
            }
            var a = t.from,
              s = t.to,
            ...
            if (t.full)
              ...
              (o(v, v.text, y),
                E && e.remove(a.line, E),
                H.length && e.insert(a.line, H));
            } else if (h == v)
              if (u.length == 1)
                o(h, h.text.slice(0, a.ch) + k + h.text.slice(s.ch), y);
              else {
          ...
          function li(e, t, n) {
            ...
            var r =
              (n && n.bias) ||
              (re(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
            (Dl(e, Al(e, t, r, !0)),
              !(n && n.scroll === !1) &&
                e.cm &&
            ...
            if (o.markedSpans)
              for (var l = 0; l < o.markedSpans.length; ++l) {
                ...
                if (
                  ...
                  return (
                    (r < 0 ? u : h) &&
                      (y = Fl(e, y, r, y.line == t.line ? o : null)),
                    y ? Zr(e, y, t, r, i) : null
                  );
                }
              }
          ...
          function Ol(e, t) {
            if (
              !(t.text.length == 1 && t.text[0] == "" && re(t.from, t.to) == 0)
            ) {
              var n = Zi(e, t);
                  ...
                  var v =
                    ...
                    k = function (H) {
                      ...
                      (Ln(e, Z, Q, Sl(e, Z)),
                        !H &&
                          e.cm &&
                          e.cm.scrollIntoView({ from: Z.from, to: gr(Z) }));
                      var ie = [];
                      vr(e, function (V, ue) {
                        (!ue &&
                          de(ie, V.history) == -1 &&
                          (Bl(V.history, Z), ie.push(V.history)),
                          Ln(V, Z, null, Sl(V, Z)));
                      });
                    },
          ...
          ((mr.prototype.clear = function () {
            ...
            (mr.prototype.find = function (e, t) {
              ...
              for (var n, r, i = 0; i < this.lines.length; ++i) {
                ...
                if (l.from != null && ((n = D(t ? o : f(o), l.from)), e == -1))
                  return n;
                if (l.to != null && ((r = D(t ? o : f(o), l.to)), e == 1))
                  return r;
              }
            ...
            (mr.prototype.attachLine = function (e) {
              if (!this.lines.length && this.doc.cm) {
                ...
                (!t.maybeHiddenMarkers ||
                  de(t.maybeHiddenMarkers, this) == -1) &&
                  (
            ...
            (mr.prototype.detachLine = function (e) {
              if (
                (this.lines.splice(de(this.lines, e), 1),
          ...
          ((kt.prototype = O(Dn.prototype, {
            ...
            setCursor: at(function (e, t, n) {
              Tl(
                this,
                Me(this, typeof e == "number" ? D(e, t || 0) : e),
                null,
                n,
              );
            }),
...
`
                      ...
                      a = function () {
                        ++l == i &&
                          lt(t, function () {
                            ...
                            (Jr(t.doc, y),
                              Cl(t.doc, pr(Me(t.doc, n), Me(t.doc, gr(y)))));
                          })();
                      },
                      s = function (y, E) {
                        if (
          ...
          function ro(e, t, n) {
            ...
            return r == null
              ? null
              : new D(t.line, r, n < 0 ? "after" : "before");
          }
            ...
            var E = function (Q, ie, V) {
                for (
                  var ue = function (Ke, st) {
                    return st
                      ? new D(n.line, a(Ke, 1), "before")
                      : new D(n.line, Ke, "after");
                  };
                  Q >= 0 && Q < i.length;
                  Q += ie
                ) {
...
`,
          ...
          oo.prototype.compare = function (e, t, n) {
            return (
              this.time + bu > e && re(t, this.pos) == 0 && n == this.button
            );
          };
          var Pn, In;
          function ku(e, t) {
                  ...
                  !(r && wu(t, i, r, o, e)) &&
                    (i == 1
                      ...
                      : i == 2
                        ...
                        : i == 3 &&
                          (se ? t.display.input.onContextMenu(e) : _i(t))));
              }
            }
          }
          ...
          function ra(e, t, n) {
            ...
            if (n == "line")
              return new _e(D(t.line, 0), Me(e.doc, D(t.line + 1, 0)));
            var r = n(e, t);
          ...
          function Cu(e, t, n, r) {
            ...
            if (
              (r.addNew && !r.extend
                ? ((a = o.sel.contains(n)),
                  a > -1 ? (l = u[a]) : (l = new _e(n, n)))
                : ((l = o.sel.primary()), (a = o.sel.primIndex)),
              r.unit == "rectangle")
            )
              (r.addNew || (l = new _e(n, n)),
                (n = Lr(e, t, !0, !0)),
                (a = -1));
            else {
              var h = ra(e, n, r.unit);
                ...
                if (((v = V), r.unit == "rectangle")) {
                  for (
                    ...
                    Ke == st
                      ...
                      : wt.length > tt &&
                        ue.push(new _e(D(Xe, tt), D(Xe, Re(wt, st, be))));
                  }
            ...
            function H(V) {
              ...
              if (be)
                if (re(be, v) != 0) {
                  ...
                  var Ne =
                    V.clientY < y.top ? -20 : V.clientY > y.bottom ? 20 : 0;
                  Ne &&
                    setTimeout(
                      lt(e, function () {
          ...
          function Du(e, t) {
            ...
            var k = o[s + (u ? -1 : 0)],
              ...
              E = y ? k.from : k.to,
              H = y ? "after" : "before";
            return n.ch == E && n.sticky == H
              ? t
              : new _e(new D(n.line, E, H), r);
          }
          function na(e, t, n, r) {
            var i, o;
            if (t.touches)
          ...
          function zn(e, t, n, r) {
            ...
            if ((k < h && (v += et(h - k)), v != u))
              return (
                Qr(i, v, D(t, 0), D(t, u.length), "+input"),
                (a.stateAfter = null),
                !0
              );
              ...
              if (r == "codepoint") {
                ...
                if (isNaN(ue)) V = null;
                  ...
                  V = new D(
                    ...
                    Math.max(
                      0,
                      Math.min(a.text.length, t.ch + n * (be ? 2 : 1)),
                    ),
                    -n,
                  );
                }
...
`)));
            ...
            (je.prototype.pollContent = function () {
              ...
              for (
                ...
                E < ue &&
                ie.charCodeAt(ie.length - E - 1) ==
                  V.charCodeAt(V.length - E - 1);
              )
                ++E;
              ...
              if (v.length > 1 || v[0] || re(be, me))
                return (Qr(e.doc, v, be, me, "+input"), !0);
            }),
          ...
          function Iu(e, t, n, r, i) {
            ...
            function k(y) {
              if (y.nodeType == 1) {
                ...
                y.nodeType == 3 &&
                  v(y.nodeValue.replace(/\u200b/g, "").replace(/\u00a0/g, " "));
            }
          ...
          function zu(e, t, n) {
            ...
            if (v) return rn(v, i);
            for (
              var k = a.nextSibling, y = l ? l.nodeValue.length - n : 0;
              k;
              k = k.nextSibling
            ) {
              if (((v = h(k, k.firstChild, 0)), v))
                return rn(D(v.line, v.ch - y), i);
              y += k.textContent.length;
            }
            for (var E = a.previousSibling, H = n; E; E = E.previousSibling) {
              if (((v = h(E, E.firstChild, -1)), v))
                return rn(D(v.line, v.ch + H), i);
          ...
          (($e.prototype.init = function (e) {
            ...
            (e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
              N && (i.style.width = "0px"),
              ye(i, "input", function () {
                (b && W >= 9 && t.hasSelection && (t.hasSelection = null),
                  n.poll());
              }),
...
`) > -1
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`));
          ...
          function Bu(e, t) {
            ...
            if (
              e.form &&
              (ye(e.form, "submit", r), !t.leaveSubmitMethodAlone)
            ) {
              var o = e.form;
              i = o.submit;
              try {
        ...
        (function (C) {
          ...
          C.defineMode("css", function (se, q) {
            ...
            function Oe(T, U) {
              ...
              if (O == "@")
                return (T.eatWhile(/[\w\\\-]/), de("def", T.current()));
              if (O == "=" || ((O == "~" || O == "|") && T.eat("=")))
                return de(null, "compare");
              if (O == '"' || O == "'")
                return ((U.tokenize = qe(O)), U.tokenize(T, U));
              if (O == "#") return (T.eatWhile(/[\w\\\-]/), de("atom", "hash"));
              if (O == "!")
                return (T.match(/^\s*\w*/), de("keyword", "important"));
            ...
            return (
              (Ie.top = function (T, U, O) {
                ...
                if (pe && /@component/i.test(T))
                  return Pe(O, U, "atComponentBlock");
                if (/^@(-moz-)?document$/i.test(T))
                  return Pe(O, U, "documentTypes");
                  ...
                  return (
                    ...
                    O.prev &&
                      ...
                      (O.type == "block" ||
                        ...
                        : ((ze == ")" &&
                            (O.type == "parens" ||
                              O.type == "atBlock_parens")) ||
                            (ze == "{" &&
                              (O.type == "at" || O.type == "atBlock"))) &&
          ...
          function De(se) {
            for (var q = {}, Fe = 0; Fe < se.length; ++Fe)
              q[se[Fe].toLowerCase()] = !0;
            return q;
          }
        ...
        (function (C) {
          ...
          (C.defineMode("xml", function (fe, Se) {
            ...
            function F(d) {
              return function (S, L) {
                for (var m; (m = S.next()) != null; ) {
                  if (m == "<")
                    return ((L.tokenize = F(d + 1)), L.tokenize(S, L));
                  if (m == ">")
                    if (d == 1) {
                      L.tokenize = B;
                      break;
            ...
            function Fe(d, S, L) {
              return d == "equals"
                ? M
                : (b.allowMissing || (w = "error"), q(d, S, L));
            }
            function M(d, S, L) {
              return d == "string"
                ? G
            ...
            return {
                ...
                if (x && x[1])
                  for (; m; )
                    if (m.tagName == x[2]) {
                      m = m.prev;
                      break;
                    } else if (b.implicitlyClosed.hasOwnProperty(N(m.tagName)))
                      m = m.prev;
                    else break;
                else if (x)
                  for (; m; ) {
              ...
              xmlCurrentContext: function (d) {
                for (var S = [], L = d.context; L; L = L.prev)
                  S.push(L.tagName);
                return S.reverse();
              },
            };
        ...
        (function (C) {
          ...
          (C.defineMode("javascript", function (De, P) {
            ...
            function R(f, g) {
              var I = f.next();
              if (I == '"' || I == "'")
                return ((g.tokenize = _(I)), g.tokenize(f, g));
              ...
              if (I == "#" && f.peek() == "!")
                return (f.skipToEnd(), N("meta", "meta"));
            ...
            function q(f, g) {
              if (!W) return !1;
              for (var I = f.localVars; I; I = I.next)
                if (I.name == g) return !0;
            ...
            function L(f) {
              ...
              if (((M.marked = "def"), !!W)) {
                ...
                P.globalVars &&
                  !S(f, g.globalVars) &&
                  (g.globalVars = new ne(f, g.globalVars));
              }
            }
            function m(f, g) {
              if (g)
                if (g.block) {
                  ...
                  return S(f, g.vars)
                    ? g
                    : new z(g.prev, new ne(f, g.vars), !1);
              else return null;
            }
            function x(f) {
              return (
            ...
            function Le(f, g) {
              ...
              if (f == "variable" || M.style == "keyword") {
                if (((M.marked = "property"), g == "get" || g == "set"))
                  return d(ve);
                var I;
                return (
                  j &&
                ...
                if (f == "number" || f == "string")
                  return (
                    (M.marked = le ? "property" : M.style + " property"),
                    d(Be)
                  );
            ...
            function Ft(f, g, I) {
              return (
                ...
                (g.lastType == "quasi" &&
                  /\{\s*$/.test(f.string.slice(0, f.pos - (I || 0))))
              );
            }
            return {
              startState: function (f) {
                ...
                return (
                  P.globalVars &&
                    typeof P.globalVars == "object" &&
                    (g.globalVars = P.globalVars),
                  g
                );
              },
              token: function (f, g) {
                  ...
                  : it == "form" && I == "{"
                    ...
                    : it == "form"
                      ...
                      : it == "stat"
                        ...
                        : X.info == "switch" &&
                            !yt &&
                            P.doubleIndentSwitch != !1
                          ? X.indented +
                            (/^(?:case|default)\b/.test(g) ? fe : 2 * fe)
                          : X.align
                            ? X.column + (yt ? 0 : 1)
                            : X.indented + (yt ? 0 : fe);
              },
      ...
      (function (At, Ot) {
        (function (C) {
          ...
          function P(oe, w, B) {
            ...
            return (
              K > -1
                ...
                : A.match(/<\/?$/) &&
                  (oe.backUp(A.length), oe.match(w, !1) || oe.match(A)),
              B
            );
          }
          var fe = {};
          ...
          function W(oe, w) {
            for (var B in oe)
              for (
                var A = w[B] || (w[B] = []), K = oe[B], ae = K.length - 1;
                ae >= 0;
                ae--
              )
                A.unshift(K[ae]);
              ...
              function N(R, _) {
                ...
                if (
                  ...
                  ((_.token = function (M, G) {
                    ...
                    (_.localMode = se),
                    (_.localState = C.startState(
                      se,
                      B.indent(_.htmlState, "", ""),
                    )));
                } else
                  _.inTag &&
                    ((_.inTag += R.current()), R.eol() && (_.inTag += " "));
                return Y;
              }
              return {
                startState: function () {
                ...
                copyState: function (R) {
                  ...
                  return (
                    R.localState &&
                      (_ = C.copyState(R.localMode, R.localState)),
                    {
                      token: R.token,
                      inTag: R.inTag,
      ...
      (function (At, Ot) {
        (function (C) {
          ...
          C.registerHelper(
            "hintWords",
            "python",
            fe.concat(Se).concat(["exec", "print"]),
          );
          function le(W) {
          ...
          (C.defineMode("python", function (W, j) {
            ...
            function $(S, L) {
              ...
              if (
                (m && (L.indent = S.indentation()), m && le(L).type == "py")
              ) {
                var x = le(L).offset;
                if (S.eatSpace()) {
                  var z = S.indentation();
            ...
            function ee(S, L, m) {
              ...
              if (S.match(_)) {
                ...
                return ne
                  ? ((L.tokenize = Ae(S.current(), L.tokenize)),
                    L.tokenize(S, L))
                  : ((L.tokenize = se(S.current(), L.tokenize)),
                    L.tokenize(S, L));
              }
              for (var p = 0; p < B.length; p++)
                if (S.match(B[p])) return "operator";
              return S.match(w)
                ? "punctuation"
            ...
            function q(S) {
              ...
              S.scopes.push({
                offset: le(S).offset + W.indentUnit,
                type: "py",
                align: null,
              });
            }
            ...
            function M(S, L) {
              for (
                var m = S.indentation();
                L.scopes.length > 1 && le(L).offset > m;
              ) {
              ...
              token: function (S, L) {
                ...
                return (
                  x &&
                    x != "comment" &&
                    (L.lastToken =
                      x == "keyword" || x == "punctuation" ? S.current() : x),
              ...
              indent: function (S, L) {
                ...
                var m = le(S),
                  x =
                    ...
                    (m.type == "py" &&
                      !S.dedent &&
                      /^(else:|elif |except |finally:)/.test(L));
                return m.align != null
                  ? m.align - (x ? 1 : 0)
                  : m.offset - (x ? K : 0);
              },
        ...
        (function (C) {
          ...
          C.defineMode("clike", function (m, x) {
            ...
            function T(he, Le) {
              ...
              if (ve == '"' || ve == "'")
                return ((Le.tokenize = U(ve)), Le.tokenize(he, Le));
              if (ct.test(ve)) {
            ...
            return {
              ...
              indent: function (he, Le) {
                ...
                var ve = he.context,
                  ...
                  Ee = Be == ve.type;
                if (
                  (ve.type == "statement" && Be == "}" && (ve = ve.prev),
                  x.dontIndentStatements)
                )
                  for (
                    ;
                    ve.type == "statement" &&
                    x.dontIndentStatements.test(ve.info);
                  )
                    ve = ve.prev;
                if (Ce.indent) {
          ...
          function b(m) {
            for (var x = {}, z = m.split(" "), ne = 0; ne < z.length; ++ne)
              x[z[ne]] = !0;
            return x;
          }
          function W(m, x) {
          ...
          function ee(m, x) {
            if ((m.backUp(1), m.match(/^(?:R|u8R|uR|UR|LR)/))) {
              ...
              return z
                ? ((x.cpp11RawStringDelim = z[1]), (x.tokenize = q), q(m, x))
                : !1;
            }
          ...
          function Fe(m, x) {
            ...
            (ne(x.keywords),
              ...
              z.length &&
                ((x.helperType = m[0]),
                C.registerHelper("hintWords", m[0], z)));
            ...
            hooks: {
              ...
              indent: function (m, x, z, ne) {
                ...
                if (x.align && x.type == "}")
                  return (
                    x.indented +
                    (m.context.type == (z || "").charAt(0) ? 0 : ne)
                  );
              },
            },
          ...
          Fe("text/x-ceylon", {
            ...
            hooks: {
              ...
              '"': function (m, x) {
                return (
                  (x.tokenize = L(m.match('""') ? "triple" : "single")),
                  x.tokenize(m, x)
                );
              },
              "`": function (m, x) {
                return !S || !m.match("`")
                  ? !1
                  : ((x.tokenize = S), (S = null), x.tokenize(m, x));
              },
              "'": function (m) {
                return (m.eatWhile(/[\w\$_\xa1-\uffff]/), "atom");
              },
              token: function (m, x, z) {
                if ((z == "variable" || z == "type") && x.prevToken == ".")
                  return "variable-2";
              },
            },
            modeProps: {
        ...
        (function (C) {
          ...
          ((C.findModeByMIME = function (fe) {
            ...
            for (var Se = 0; Se < C.modeInfo.length; Se++) {
              ...
              if (le.mimes) {
                for (var b = 0; b < le.mimes.length; b++)
                  if (le.mimes[b] == fe) return le;
              }
            }
            ...
            (C.findModeByExtension = function (fe) {
              ...
              for (var Se = 0; Se < C.modeInfo.length; Se++) {
                var le = C.modeInfo[Se];
                if (le.ext) {
                  for (var b = 0; b < le.ext.length; b++)
                    if (le.ext[b] == fe) return le;
                }
              }
            }),
        ...
        (function (C) {
          ...
          (C.defineMode(
            ...
            function (De, P) {
              ...
              for (var W in b)
                b.hasOwnProperty(W) &&
                  P.tokenTypeOverrides[W] &&
                  (b[W] = P.tokenTypeOverrides[W]);
              var j = /^([*\-_])(?:\s*\1){2,}\s*$/,
                oe = /^(?:[*\-+]|^[0-9]+([.)]))\s+/,
                w = /^\[(x| )\](?=\s)/i,
              ...
              function ee(p, c) {
                ...
                if (
                  ...
                  for (
                    c.list = null;
                    we < c.listStack[c.listStack.length - 1];
                  )
                    (c.listStack.pop(),
                      c.listStack.length
                  ...
                  if (te && c.indentation <= Ce && (qe = p.match(ae, !0)))
                    return (
                      ...
                      (c.localMode =
                        ...
                        le(qe[2] || P.fencedCodeBlockDefaultMode)),
              ...
              function M(p, c) {
                ...
                if (J === "`") {
                  var Ce = c.formatting;
                  (P.highlightFormatting && (c.formatting = "code"),
                    p.eatWhile("`"));
                  var we = p.current().length;
                  if (c.code == 0 && (!c.quote || we == 1))
                    return ((c.code = we), q(c));
                  if (we == c.code) {
                    var de = q(c);
                    return ((c.code = 0), de);
                ...
                if (
                  ...
                  return (
                    p.backUp(1),
                    (c.htmlState = C.startState(fe)),
                    Y(p, c, Ae)
                  );
                }
                if (P.xml && J === "<" && p.match(/^\/\w*?>/))
                ...
                if (J === "*" || J === "_") {
                  ...
                  var Ue = p.peek() || " ",
                    et =
                      !/\s/.test(Ue) &&
                      (!N.test(Ue) || /\s/.test(Re) || N.test(Re)),
                    xe =
                      !/\s/.test(Re) &&
                      (!N.test(Re) || /\s/.test(Ue) || N.test(Ue)),
                    Ie = null,
                    T = null;
                  if (
                    (Pe % 2 &&
                    ...
                    (P.highlightFormatting &&
                      (c.formatting =
                        Ie == null ? "strong" : T == null ? "em" : "strong em"),
                      Ie === !0 && (c.em = J),
                      T === !0 && (c.strong = J));
                    var de = q(c);
                    return (
                ...
                if (
                  ...
                  ((c.emoji = !0),
                    P.highlightFormatting && (c.formatting = "emoji"));
                  var U = q(c);
                  return ((c.emoji = !1), U);
                }
                return (
        ...
        (function (C) {
          ...
          function P(W) {
            ...
            (typeof oe == "string" && (oe = document.createTextNode(oe)),
              j.appendChild(oe),
              W.display.lineSpace.insertBefore(
                j,
                W.display.lineSpace.firstChild,
              ));
          }
          function fe(W) {
            setTimeout(function () {
              ...
              if (W.lineCount() == 1) {
                ...
                j =
                  oe.nodeName == "TEXTAREA"
                    ? !W.getLine(0).length
                    : !/[^\u200b]/.test(
                        oe.querySelector(".CodeMirror-line").textContent,
                      );
              }
              j ? P(W) : De(W);
            }, 20);
          ...
          function le(W) {
            var j = W.getWrapperElement(),
              oe = b(W);
            ((j.className =
              j.className.replace(" CodeMirror-empty", "") +
              (oe ? " CodeMirror-empty" : "")),
              oe ? P(W) : De(W));
          }
          function b(W) {
        ...
        (function (C) {
            ...
            (C.simpleMode = function (w, B) {
              ...
              var ce = {
                ...
                copyState: function (ee) {
                  ...
                  (ee.localState &&
                    (Ae.localState = C.copyState(ee.local.mode, ee.localState)),
                  ...
                  for (var se = ee.persistentStates; se; se = se.next)
                    Ae.persistentStates = {
                      ...
                      spec: se.spec,
                      state:
                        se.state == ee.localState
                          ? Ae.localState
                          : C.copyState(se.mode, se.state),
                ...
                innerMode: function (ee) {
                  return (
                    ee.local && { mode: ee.local.mode, state: ee.localState }
                  );
                },
                indent: oe(A, K),
              };
          ...
          function De(w, B) {
            if (!w.hasOwnProperty(B))
              throw new Error("Undefined state " + B + " in simple mode");
          }
          function P(w, B) {
            if (!w) return /(?:)/;
            var A = "";
              ...
              for (var R = w[K.state], _ = 0; _ < R.length; _++) {
                ...
                if (ce) {
                  (Y.data.next
                    ...
                    Y.data.indent &&
                      K.indent.push(A.indentation() + B.indentUnit),
                  ...
                  if (
                    ...
                    return (
                      A.backUp(ce[0].length - (ce[1] ? ce[1].length : 0)),
                      $[0]
                    );
                  } else return $ && $.join ? $[0] : $;
                }
          ...
          function oe(w, B) {
            return function (A, K, ae) {
              if (A.local && A.local.mode.indent)
                return A.local.mode.indent(A.localState, K, ae);
              if (
                A.indent == null ||
                A.local ||
        ...
        (function (C) {
          ...
          function le(w, B, A) {
            var K = w.getLineHandle(B.line),
              ...
              F = A && A.afterCursor;
            F == null &&
              (F = /(^| )cm-fat-cursor($| )/.test(
                w.getWrapperElement().className,
              ));
            var N = Se(A),
              R =
                (!F &&
                  ae >= 0 &&
                  N.test(K.text.charAt(ae)) &&
                  fe[K.text.charAt(ae)]) ||
          ...
          function W(w, B, A) {
            for (
              ...
              if (
                _ &&
                (_.match || ae !== !1) &&
                w.getLine(_.from.line).length <= K
              ) {
                var Y = _.match
                  ? "CodeMirror-matchingbracket"
                  : "CodeMirror-nonmatchingbracket";
                (F.push(
                  w.markText(_.from, P(_.from.line, _.from.ch + 1), {
                    className: Y,
                  }),
                ),
                  _.to &&
                    ...
                    F.push(
                      w.markText(_.to, P(_.to.line, _.to.ch + 1), {
                        className: Y,
                      }),
                    ));
              }
          ...
          function j(w) {
            w.operation(function () {
              (w.state.matchBrackets.currentlyHighlighted &&
                ...
                (w.state.matchBrackets.currentlyHighlighted = W(
                  w,
                  !1,
      ...
      (function (At, Ot) {
        (function (C) {
          ...
          C.defineOption("autoCloseBrackets", !1, function (F, N, R) {
            (R &&
              R != C.Init &&
              (F.removeKeyMap(Se), (F.state.closeBrackets = null)),
              N &&
                (le(fe(N, "pairs")),
                (F.state.closeBrackets = N),
                F.addKeyMap(Se)));
          });
          function fe(F, N) {
          ...
          function j(F) {
            ...
            for (
              var R = fe(N, "pairs"), _ = F.listSelections(), Y = 0;
              Y < _.length;
              Y++
            ) {
...
`;
          ...
          function w(F, N) {
            for (
              var R = [], _ = F.listSelections(), Y = 0, ce = 0;
              ce < _.length;
              ce++
            ) {
              var $ = _[ce];
          ...
          function A(F, N) {
            ...
            for (
              ...
              if (se && !M.empty()) d = "surround";
                ...
                ee && ae(F, G)
                  ? (d = "both")
                  : $.indexOf(N) >= 0 &&
                      F.getRange(G, P(G.line, G.ch + 3)) == N + N + N
                    ? (d = "skipThree")
                    : (d = "skip");
              else if (
                ee &&
                ...
                if (
                  G.ch > 2 &&
                  /\bstring/.test(F.getTokenTypeAt(P(G.line, G.ch - 2)))
                )
                  return C.Pass;
                d = "addFour";
              } else if (ee) {
                ...
                se &&
                (S.length === 0 || /\s/.test(S) || ce.indexOf(S) > -1)
              )
                d = "both";
              else return C.Pass;
              if (!q) q = d;
            ...
            F.operation(function () {
              if (q == "skip") w(F, 1);
                ...
                for (var z = F.getSelections(), ne = 0; ne < z.length; ne++)
                  z[ne] = m + z[ne] + x;
                (F.replaceSelections(z, "around"),
                  (z = F.listSelections().slice()));
                for (var ne = 0; ne < z.length; ne++) z[ne] = B(z[ne]);
                F.setSelections(z);
              } else
                q == "both"
                  ? (F.replaceSelection(m + x, null),
                    F.triggerElectric(m + x),
                    w(F, -1))
                  : q == "addFour" &&
                    (F.replaceSelection(m + m + m + m, "before"), w(F, 1));
            });
          }
          function K(F, N) {
